...
export default function SportPage({ sport }: SportPageProps) {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative min-h-[40vh] max-h-[60vh] flex items-center justify-center max-w-7xl mx-auto overflow-hidden rounded-lg mt-8">
                  ...
                  {parts.map((part, partIndex) => {
                    if (partIndex % 2 === 1) {
                      ...
                      return (
                        <h3
                          key={partIndex}
                          className="text-xl font-bold text-gray-900 mb-2 mt-6"
                        >
                          {part}
                        </h3>
                      )
                ...
                >
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9v-9m0-9v9m0 9c0-5 0-9 0-9m0 0c0 5 0 9 0 9"
                    />
                  </svg>
