        ...
        <div className="flex-shrink-0 pb-4 mb-4 border-b border-gray-200">
          ...
          <div className="mt-3 flex flex-col sm:flex-row gap-2">
            <a
              ...
              className="w-full sm:w-auto inline-flex justify-center items-center px-4 py-2 bg-red-700 text-white text-sm font-medium rounded-md hover:bg-red-800 transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
            >
              <svg
            ...
            <a
              href={file}
              download
              className="w-full sm:w-auto inline-flex justify-center items-center px-4 py-2 bg-gray-600 text-white text-sm font-medium rounded-md hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
            >
              <svg
                className="w-4 h-4 mr-2"
                fill="none"
              ...
              <div className="flex flex-col items-center justify-center h-full p-8 text-center">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 max-w-md">
                  ...
                  <p className="text-blue-700 mb-4">
                    L‘aperçu peut être bloqué par votre navigateur pour des
                    raisons de sécurité.
                  </p>
                  <p className="text-blue-700 mb-4">
                    Utilisez le bouton de téléchargement pour ouvrir ce
                    document.
                  </p>
                  <a
                    href={file}
