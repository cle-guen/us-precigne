...
export const sports: Sport[] = [
  {
    ...
    contacts: {
      ...
      phone: '+33 6 89 90 18 46',
      email: 'valsteph.jubault@orange.fr',
    },
    pdfs: [],
  },
  {
    ...
    pdfs: [
      ...
      {
        label: 'Fiche inscription gym 2025-2026',
        file: '/pdfs/fiche_inscription_gym_2025_2026.pdf',
      },
      { label: 'Questionnaire santé', file: '/pdfs/questionnaire_sante.pdf' },
      {
        label: 'Résumé des garanties MAIF',
        file: '/pdfs/resume_garanties_MAIF.pdf',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    pdfs: [
      {
        label: 'Fiche inscription 2025-2026',
        file: '/pdfs/tennis_fiche_inscription_2025_2026.pdf',
      },
      { label: 'Tarifs 2021-2022', file: '/pdfs/tennis_tarifs_2025_2026.pdf' },
      {
        label: 'Formulaire QP sport majeurs',
        file: '/pdfs/tennis_formulaire_qp_sport_majeurs.pdf',
      },
      {
        label: 'Questionnaire santé mineurs',
        file: '/pdfs/tennis_questionnaire_sante_mineurs.pdf',
      },
      {
        label: 'Modèle certificat médical',
        file: '/pdfs/tennis_modele_certificat_medical.pdf',
      },
      {
        label: 'Modèle attestation adulte',
        file: '/pdfs/tennis_modele_attestation_adulte.pdf',
      },
      {
        label: 'Modèle attestation mineur',
        file: '/pdfs/tennis_modele_attestation_mineur.pdf',
      },
    ],
  },
  {
    ...
    pdfs: [
      {
        label: "Bulletin d'inscription 2025-2026",
        file: '/pdfs/yoga_bulletin_inscription_2025_2026.pdf',
      },
      {
        label: 'Questionnaire santé CERFA',
        file: '/pdfs/yoga_questionnaire_sante_cerfa.pdf',
      },
